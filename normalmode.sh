...
do
	...
	echo "stable vaccine$i" >> /home/doc2/Vaccines/vaccine_$i.txt
	echo "symptom$i" >> /home/p${i}_1/Symptoms/symptom_1.txt
	echo "severe symptom$i" >> /home/p${i}_2/Symptoms/symptom_1.txt
